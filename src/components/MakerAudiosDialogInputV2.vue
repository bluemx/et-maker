...
const inputText = useStorage('etmaker-dialogInputV2', null);
...
const syncScroll = () => {
    ...
    let currentColorClass = ''; // To keep track of the current color class
    ...
    const formattedLines = lines.map(line => {
        ...
        if (match) {
            ...
            currentColorClass = props.symC[letterIndex]; // Update the current color class
            if (voice) {
